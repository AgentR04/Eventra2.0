...
const FeaturesSection = () => {
  const features = [
    ...
    },
    {
      ...
      id: "team-management",
      color: "#b4002c" // slightly different maroon
    },
    {
    ...
    },
    {
      ...
      id: "communication",
      color: "#a30026" // another maroon variant
    },
    {
  ...
  return (
    <section id="features" className="py-24 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        ...
        <div className="absolute top-1/3 -right-48 w-96 h-96 rounded-full bg-white opacity-5"></div>
        <div className="absolute -bottom-24 left-1/3 w-64 h-64 rounded-full bg-white opacity-5"></div>
      </div>
