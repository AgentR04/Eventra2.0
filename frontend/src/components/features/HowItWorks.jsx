  ...
  return (
    <section className="py-0 bg-maroon text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-block bg-white text-maroon px-4 py-1 rounded-full text-sm font-bold tracking-wide mb-3">SIMPLE PROCESS</span>
          <h2 className="text-4xl font-bold mb-4">How Eventra Works</h2>
